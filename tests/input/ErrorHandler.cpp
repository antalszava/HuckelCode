...
void ErrorHandler::openBabelInputFileNotOpen()
{
...
{
    std::cerr << "No atoms found in the PDB file. Please check if it has correct lines starting with the ATOM keyword." << std::endl;
}
...
{
    std::cerr << "Cannot open " << filename << ", please check if it exists in the current folder." << std::endl;
}
