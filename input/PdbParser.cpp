//
// Created by toncsi on 2017.03.04..
//
...
bool PdbParser::read()
{
    ...
    {
        if (readPdb<ESBTL::ASCII, CustomMandatoryFields>(inputFileName, sel, builder, Accept_none_occupancy_policy())) {
            ...
            outputFile << "Geomxetry" << std::endl;
            outputFile << sel.getNblines() << std::endl;
