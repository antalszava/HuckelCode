...
/*     SUPPOSE DECOMPOSITION WILL FAIL */
    ...
    *fail = 1;
    ...
    i__1 = *n;
    std::cout << "diag.cpp nagy for ciklus (Choleski poz. def. mx-ra): " << std::endl;
    double end = omp_get_wtime();
    double elapsed_secs = double(end - beginMP);
    ...
    //#pragma omp parallel
    {
        ...
        double end = omp_get_wtime();
        double elapsed_secs = double(end - beginMP);
        std::cout << "remaining columns elott: " << elapsed_secs << std::endl;
    ...
    double elapsed_secs1 = double(end1 - beginMP);
    std::cout << "remaining columns elott: " << elapsed_secs1 << std::endl;
    *fail = 0;
    return 0;
}
