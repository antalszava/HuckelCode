...
*
****************************************************************************/
void init_FMO_file(detail_type *details,long num_orbs,real num_electrons)
{
int i;
...
*
****************************************************************************/
void build_FMO_overlap(detail_type *details,long num_orbs,int num_atoms,
...
*
****************************************************************************/
void build_FMO_hamil(detail_type *details,long num_orbs,int num_atoms,
                     hermetian_matrix_type hamil,int *orbital_lookup_table)
{
FMO_frag_type *FMO_frag;
int i,j;
int itab,jtab,FMO_itab,FMO_jtab;
...
*
****************************************************************************/
void diagonalize_FMO(detail_type *details,real *work1,real *work2,real *work3,
                     complex *cmplx_hamil,complex *cmplx_overlap,complex *cmplx_work)
{
FMO_frag_type *FMO_frag;
int i,j,k,itab,jtab,ktab;
long num_orbs,diag_error;
real *occupations;
int num_frags;
#ifdef USE_LAPACK
char jobz, uplo;
...
*
****************************************************************************/
void tform_wavefuncs_to_FMO_basis(detail_type *details,long num_orbs,int num_atoms,eigenset_type eigenset,
...
*
****************************************************************************/
void tform_matrix_to_FMO_basis(detail_type *details,long num_orbs,int num_atoms,real *AO_matR,real *AO_matI,
                               real *temp_matR,real *temp_matI,
                               complex_matrix_type cmplx_mat,int *orbital_lookup_table)
{
FMO_frag_type *FMO_frag;
...
*
****************************************************************************/
void tform_hermetian_matrix_to_FMO_basis(detail_type *details,long num_orbs,int num_atoms,hermetian_matrix_type herm_mat,
                                         real *temp_matR,real *temp_matI,hermetian_matrix_type results,
                                         int *orbital_lookup_table)
{
FMO_frag_type *FMO_frag;
